...
# Eventos para o multiplayer
CONNECTED = pygame.USEREVENT
PLAYER_ENTERED = pygame.USEREVENT + 1
PLAYER_MOVED = pygame.USEREVENT + 2
...
player = None
player_sprites = None
# Grupo de sprites para os jogadores conectados (exceto o local)
remote_player_sprites = None
